...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (let hero of superheroes) {
        ...
        <div class= "image"> ${hero.url}</div>
        <div class= "universe"> Вселенная: ${hero.universe}</div>
        <div class= "alterego"> Альтер эго: ${hero.alterego}</div>
        <div class= "occupation"> Род деятельности: ${hero.occupation}</div>
        <div class= "friends"> Друзья: ${hero.friends}</div>
        <div class= "superpowers"> Суперсилы: ${hero.superpowers}</div>
        <div class= "info"> ${hero.info}</div>
        </div>`
    }
    document.getElementById(`superheroesContent`).innerHTML = `${superheroesContent}`;
});